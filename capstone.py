...
image = Image.open("HR-Solution.jpg")
st.image(image,width=500)
st.title('Employee Churn Analysis')

mlmodel = st.selectbox('Please select the maschine learning model',['Gradient Boosting','KNN','RandomForest','XGBoost'])
...
time_spend_company = st.sidebar.slider('Select a number for Workyear', min_value=1, max_value=11, value=5, step=1) 
